...
.then(pred_json => {
   weights=`http://35.184.91.84:5000/${pred_json.data['model_json']}`
 names=pred_json.data['names']
...
// for (i = 0; i<names_class.names.length; ++i) {
//   names.push(names_class.names[i]);
// }
...
//const vvideo = document.getElementById('webcam');
